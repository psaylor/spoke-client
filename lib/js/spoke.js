...
define(['clientSocket', 'crossBrowserAudio', 'microphone', 'player', 
    'recognizer', 'recorder', 'sharedAudio', 'utils'], 
    function(clientSocket, crossBrowserAudio, microphone, Player, recognizer,
        Recorder, sharedAudio, utils) {
